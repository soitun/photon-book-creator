...
2. Create a `scss` folder inside the `mobile` folder and put our sass sources inside:
...
3. Customize the `sass` task inside the `gulpfile.js` to be coherent with your project scaffolding:
